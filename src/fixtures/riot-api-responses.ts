 ...
 */
function createSuccessResponse(tierId: number, name = "TestPlayer", tag = "123"): V3MmrResponse {
 ...
 */
const successResponses: Record<number, V3MmrResponse> = {} as Record<number, V3MmrResponse>;
